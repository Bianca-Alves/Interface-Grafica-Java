package TelaCadastrarFornecedor;
...
public class TelaCadastrarFornecedor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaCadastrarFornecedor frame = new TelaCadastrarFornecedor();
	...
	public TelaCadastrarFornecedor() {
		...
		setIconImage(new ImageIcon(TelaCadastrarFornecedor.class.getResource("../imagens/icon.png")).getImage());
		...
		btnNewButton.setIcon(new ImageIcon(TelaCadastrarFornecedor.class.getResource("../imagens/correios.jpg")));
		...
		btnNewButton_1.setIcon(new ImageIcon(TelaCadastrarFornecedor.class.getResource("../imagens/save.png")));
		...
		btnNewButton_2.setIcon(new ImageIcon(TelaCadastrarFornecedor.class.getResource("../imagens/close.png")));
